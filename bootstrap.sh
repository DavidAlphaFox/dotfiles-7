...
BASE_PKGS="chere,ctags,git-completion,psmisc,screen,tree,vim,gvim,xfce4-session,gtk2.0-engines-murrine,cygutils-x11,alacarte,file-roller,dos2unix,seahorse,seahorse-tool"
