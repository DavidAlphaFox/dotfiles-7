...
call s:h("CursorLineNr", { "fg": s:dark_purple }) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
...
call s:h("TabLine", { "fg": s:light_grey }) " tab pages line, not active tab page label
call s:h("TabLineFill", {}) " tab pages line, where there are no labels
call s:h("TabLineSel", { "fg": s:white, "bg": s:dark_grey }) " tab pages line, active tab page label
